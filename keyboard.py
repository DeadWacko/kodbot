...
rate_lesson_one_button = InlineKeyboardButton('1 - очень плохо 🥺', callback_data='one')
rate_lesson_two_button = InlineKeyboardButton('2', callback_data='two')
rate_lesson_three_button = InlineKeyboardButton('3', callback_data='three')
rate_lesson_four_button = InlineKeyboardButton('4', callback_data='four')
rate_lesson_five_button = InlineKeyboardButton('5 - великолепно 🤠', callback_data='five')
...
rate_work_one_button = InlineKeyboardButton('1 - я не справился 🥺', callback_data='one')
rate_work_two_button = InlineKeyboardButton('2', callback_data='two')
rate_work_three_button = InlineKeyboardButton('3', callback_data='three')
rate_work_four_button = InlineKeyboardButton('4', callback_data='four')
rate_work_five_button = InlineKeyboardButton('5 - все круто 🤠', callback_data='five')
...
rate_explanations_one_button = InlineKeyboardButton('1 - ничего не понял 🥺',
                                                    callback_data='one')
rate_explanations_two_button = InlineKeyboardButton('2', callback_data='two')
rate_explanations_three_button = InlineKeyboardButton('3', callback_data='three')
rate_explanations_four_button = InlineKeyboardButton('4', callback_data='four')
rate_explanations_five_button = InlineKeyboardButton('5 - все понял 🤠', callback_data='five')
...
rate_skill_one_button = InlineKeyboardButton('1 - ничего не могу 🥺', callback_data='one')
rate_skill_two_button = InlineKeyboardButton('2', callback_data='two')
rate_skill_three_button = InlineKeyboardButton('3', callback_data='three')
rate_skill_four_button = InlineKeyboardButton('4', callback_data='four')
rate_skill_five_button = InlineKeyboardButton('5 - все могу 🤠', callback_data='five')
